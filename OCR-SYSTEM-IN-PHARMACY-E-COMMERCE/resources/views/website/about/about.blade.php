...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}about/fonts/icomoon/style.css">
...
<div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page" style="background-image: url('{{asset('/')}}website/assets/images/hero/hero_1.jpg');
        background-size:100% 100%; height: 600px;width: 100%;">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6">
                    <div class="block-16">
                        <figure>
                            <img src="{{asset('/')}}about/images/bg_1.jpg" alt="Image placeholder" class="img-fluid rounded">
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6 order-md-2">
                    <div class="block-16">
                        <figure>
                            <img src="{{asset('/')}}about/images/hero_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                            <a href="https://vimeo.com/channels/staffpicks/93951774" class="play-button popup-vimeo"><span
                                    class="icon-play"></span></a>
            ...
            <div class="row">
                    ...
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{asset('/')}}about/images/person_1.jpg" alt="Image placeholder" class="mb-4">
                ...
                <div class="col-md-6 col-lg-6 mb-5">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{asset('/')}}about/images/person_2.jpg" alt="Image placeholder" class="mb-4">
                ...
                <div class="col-md-6 col-lg-6 mb-5">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{asset('/')}}about/images/person_3.jpg" alt="Image placeholder" class="mb-4">
                ...
                <div class="col-md-6 col-lg-6 mb-5">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{asset('/')}}about/images/person_4.jpg" alt="Image placeholder" class="mb-4">
...
<script src="{{asset('/')}}about/js/jquery-3.3.1.min.js"></script>
<script src="{{asset('/')}}about/js/jquery-ui.js"></script>
