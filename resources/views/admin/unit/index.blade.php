            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('unit.new')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input12" class="col-sm-3 col-form-label">Unit Code</label>
                            <div class="col-sm-9">
                                <input type="text" name="code" class="form-control" id="horizontal-firstname-input12"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
