...
<head>
    ...
    <meta charset="utf-8" />
    <title>Pharma | @yield('title')</title>
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="{{asset('/')}}admin/assets/images/users/WhatsApp Image 2024-01-11 at 00.45.36_45fed072.jpg"
                             alt="Header Avatar">
                        <span class="d-none d-xl-inline-block ml-1">Moon Store</span>
