                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider" style="background-image: url({{asset('/')}}website/assets/images/hero/sh1.jpg);">
                                <div class="content">
                                    ...
                                    <div class="button">
                                        <a href="{{ route('allProducts') }}" class="btn">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-6 col-12">
                            ...
                            <div class="hero-small-banner style2">
                                <div class="content">
                                    ...
                                    <div class="button">
                                        <a class="btn" href="{{ route('allProducts') }}">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url('{{asset('/')}}website/assets/images/banner/b1.jpg' );background-size:522px 307px;; background-position: 169% 81%;" >
                        <div class="content">
                            ...
                            <div class="button">
                                <a href="{{ route('allProducts') }}" class="btn">View Details</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                <div class="product-image">
                                    ...
                                    <div class="button">
                                        <a href="{{ route('allProducts') }}" class="btn"><i class="lni lni-cart"></i> Shop Now  </a>
                                    </div>
                                </div>
                                <div class="product-info">
