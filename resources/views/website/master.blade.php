...
<head>
  ...
  {{-- //pharma Site --}}
    ...
    <link rel="stylesheet" href="{{asset('/')}}about/css/jquery-ui.css">
    ...
    <link rel="stylesheet" href="{{asset('/')}}about/scss/_site-blocks.scss">
    <link rel="stylesheet" href="{{asset('/')}}about/scss/_site-blocks.scss">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    {{-- <div class="top-middle">
                        <ul class="useful-links">
                            ...
                            <li><a href="{{route('image')}}">Upload Image</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-3 col-7">
                    ...
                    <a class="navbar-brand" href="{{route('home')}}">
                        <img src="{{asset('/')}}website/assets/images/logo/l1.jpg" alt="Logo" height="75" width="30" style="padding: 0px 0px;">
                    </a>
                ...
                <div class="col-lg-5 col-md-7 d-xs-none">
                    <div class="main-menu-search">
                        ...
                        <div class="navbar-search search-style-5" name="category">
                            <div class="search-select" name="category">
                                <div class="select-position" name="category">
                                    <select id="select1" class="input-select" name="category">
                            ...
                            <div class="search-input">
                                <input type="text" name="products" placeholder="Search" value="{{request('products')}}">
                            </div>
                        ...
                        <div class="navbar-cart">
                            ...
                            <div class="cart-items">
                                <a href="javascript:void(0)" class="main-btn">
                                    ...
                                    <span class="total-items">{{$totalCartProduct}}</span>
                                </a>

                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{$totalCartProduct}} Items</span>
        ...
        <div class="row align-items-center">
                  ...
                  <nav class="navbar navbar-expand-lg">
                      ...
                      <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                          <ul id="nav" class="navbar-nav ms-auto">
                              ...
                              <li class="nav-item">
                                  <a href="{{route('allProducts')}}" class="active" aria-label="Toggle navigation">All Product</a>
                              </li>
                             
                              <li class="nav-item">
                                  <a href="{{route('image')}}" class="active" aria-label="Toggle navigation">Upload Image</a>
                              </li>
                              <li class="nav-item">
                                  <a class="dd-menu collapsed" href="javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#submenu-1-2" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">All Page</a>
                                  <ul class="sub-menu collapse" id="submenu-1-2">
                                     
                                      <li class="nav-item">
                                        <a href="{{route('customer-login')}}" class="active" aria-label="Toggle navigation">Sign In</a>
                                     </li>

                                      <li class="nav-item">
                                        <a href="{{route('customer-register')}}" class="active" aria-label="Toggle navigation">Register</a>
                                     </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('contact')}}" class="active" aria-label="Toggle navigation">Contact</a>
                                    </li>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="nav-social">
                    ...
                    <ul>
                        <li>
                            <a href="https://www.facebook.com/farjanaakter.eity.9"><i class="lni lni-facebook-filled"></i></a>
                        </li>
                        <li>
                            <a href="https://www.facebook.com/farjanaakter.eity.9"><i class="lni lni-twitter-original"></i></a>
                        </li>
                        <li>
                            <a href="https://www.facebook.com/farjanaakter.eity.9"><i class="lni lni-instagram"></i></a>
                        </li>
                        <li>
                            <a href="https://www.facebook.com/farjanaakter.eity.9"><i class="lni lni-skype"></i></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="footer-logo">
                            <a href="{{route('home')}}">
                                <img src="{{asset('/')}}website/assets/images/logo/l1.jpg" alt="#" height="70" width="30">
                            </a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <div class="single-footer f-contact">
                            ...
                            <p class="mail">
                                <a href="{{ route('home') }}"><span class="__cf_email__" data-cfemail="98ebede8e8f7eaecd8ebf0f7e8ffeaf1fcebb6fbf7f5">[email&#160;protected]</span></a>
                            </p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <div class="single-footer f-link">
                            ...
                            <ul>
                               <li><a href="javascript:void(0)">ACI Pharmaceuticals Limited </a></li>
                                <li><a href="javascript:void(0)">Healthcare Limited</a></li>
                                <li><a href="javascript:void(0)">Healthcare Pharmaceuticals Limited</a></li>
                                <li><a href="javascript:void(0)">Renata Limited</a></li>
                                <li><a href="javascript:void(0)">Beximco Pharmaceuticals Ltd</a></li>
                            </ul>
                        </div>
